...
a.eq(d);m&&(b[0]=l.call(this,d,f.html()));oa(f,b,c,e)});if(h){var n=kb(b,a[0].ownerDocument,!1,a,e),p=n.firstChild;1===n.childNodes.length&&(n=p);if(p||e){p=d.map(F(n,"script"),ac);for(f=p.length;g<h;g++){var r=n;g!==k&&(r=d.clone(r,!0,!0),f&&d.merge(p,F(r,"script")));c.call(a[g],r,g)}if(f)for(n=p[p.length-1].ownerDocument,d.map(p,bc),g=0;g<f;g++)r=p[g],mb.test(r.type||"")&&!t.access(r,"globalEval")&&d.contains(n,r)&&(r.src&&"module"!==(r.type||"").toLowerCase()?d._evalUrl&&!r.noModule&&d._evalUrl(r.src,
...
this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&a<b?[this[a]]:[])},end:function(){return this.prevObject||this.constructor()},push:Za,sort:U.sort,splice:U.splice};d.extend=d.fn.extend=function(){var a,b,c,e=arguments[0]||{},f=1,g=arguments.length,h=!1;"boolean"===typeof e&&(h=e,e=arguments[f]||{},f++);"object"===typeof e||q(e)||(e={});for(f===g&&(e=this,f--);f<g;f++)if(null!=(a=arguments[f]))for(b in a){var k=a[b];if("__proto__"!==b&&e!==k)if(h&&k&&(d.isPlainObject(k)||(c=Array.isArray(k)))){var l=
...
a.querySelectorAll("[id~\x3d"+H+"-]").length||J.push("~\x3d");var b=A.createElement("input");b.setAttribute("name","");a.appendChild(b);a.querySelectorAll("[name\x3d'']").length||J.push("\\[[\\x20\\t\\r\\n\\f]*name[\\x20\\t\\r\\n\\f]*\x3d[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll(":checked").length||J.push(":checked");a.querySelectorAll("a#"+H+"+*").length||J.push(".#.+[+~]");a.querySelectorAll("\\\f");J.push("[\\r\\n\\f]")}),f(function(a){a.innerHTML="\x3ca href\x3d'' disabled\x3d'disabled'\x3e\x3c/a\x3e\x3cselect disabled\x3d'disabled'\x3e\x3coption/\x3e\x3c/select\x3e";
var b=A.createElement("input");b.setAttribute("type","hidden");a.appendChild(b).setAttribute("name","D");a.querySelectorAll("[name\x3dd]").length&&J.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?\x3d");2!==a.querySelectorAll(":enabled").length&&J.push(":enabled",":disabled");Q.appendChild(a).disabled=!0;2!==a.querySelectorAll(":disabled").length&&J.push(":enabled",":disabled");a.querySelectorAll("*,:x");J.push(",.*:")});(G.matchesSelector=X.test(I=Q.matches||Q.webkitMatchesSelector||Q.mozMatchesSelector||
Q.oMatchesSelector||Q.msMatchesSelector))&&f(function(a){G.disconnectedMatch=I.call(a,"*");I.call(a,"[s!\x3d'']:x");F.push("!\x3d",":((?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?\x3d)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")});
...
function(a){var b="",c=0,d=a.nodeType;if(!d)for(;d=a[c++];)b+=ka(d);else if(1===d||9===d||11===d){if("string"===typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)b+=ka(a)}else if(3===d||4===d)return a.nodeValue;return b},D=b.selectors={cacheLength:50,createPseudo:d,match:Y,attrHandle:{},find:{},relative:{"\x3e":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){a[1]=a[1].replace(da,
...
" ")}),g=g.slice(k.length);for(f in D.filter)!(d=Y[f].exec(g))||h[f]&&!(d=h[f](d))||(k=d.shift(),e.push({value:k,type:f,matches:d}),g=g.slice(k.length));if(!k)break}return c?g.length:g?b.error(a):T(a,l).slice(0)},xa=b.compile=function(a,b){var c,d=[],e=[],f=U[a+" "];if(!f){b||(b=aa(a));for(c=b.length;c--;)f=z(b[c]),f[H]?d.push(f):e.push(f);f=U(a,kc(e,d));f.selector=a}return f},Ea=b.select=function(a,b,c,d){var e,f,g,h="function"===typeof a&&a,l=!d&&aa(a=h.selector||a);c=c||[];if(1===l.length){var k=
...
else this.attr(e,b[e])}else if(a=v.getElementById(e[2]))this[0]=a,this.length=1;return this}return a.nodeType?(this[0]=a,this.length=1,this):q(a)?void 0!==c.ready?c.ready(a):a(d):d.makeArray(a,this)}).prototype=d.fn;var mc=d(v),nc=/^(?:parents|prev(?:Until|All))/,oc={children:!0,contents:!0,next:!0,prev:!0};d.fn.extend({has:function(a){var b=d(a,this),c=b.length;return this.filter(function(){for(var a=0;a<c;a++)if(d.contains(this,b[a]))return!0})},closest:function(a,b){var c,e=0,f=this.length,g=[],
...
E.option=[1,"\x3cselect multiple\x3d'multiple'\x3e","\x3c/select\x3e"]);var Zb=/<|&#?\w+;/,rc=/^key/,sc=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,Hb=/^([^.]*)(?:\.(.+)|)/;d.event={global:{},add:function(a,b,c,e,f){var g,h,k,l,m=t.get(a);if(ha(a)){if(c.handler){var n=c;c=n.handler;f=n.selector}f&&d.find.matchesSelector(ia,f);c.guid||(c.guid=d.guid++);(h=m.events)||(h=m.events=Object.create(null));(g=m.handle)||(g=m.handle=function(b){return"undefined"!==typeof d&&d.event.triggered!==b.type?
d.event.dispatch.apply(a,arguments):void 0});b=(b||"").match(R)||[""];for(m=b.length;m--;){var p=Hb.exec(b[m])||[],r=k=p[1],u=(p[2]||"").split(".").sort();r&&(p=d.event.special[r]||{},r=(f?p.delegateType:p.bindType)||r,p=d.event.special[r]||{},k=d.extend({type:r,origType:k,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:u.join(".")},n),(l=h[r])||(l=h[r]=[],l.delegateCount=0,p.setup&&!1!==p.setup.call(a,e,u,g)||a.addEventListener&&a.addEventListener(r,
g)),p.add&&(p.add.call(a,k),k.handler.guid||(k.handler.guid=c.guid)),f?l.splice(l.delegateCount++,0,k):l.push(k),d.event.global[r]=!0)}}},remove:function(a,b,c,e,f){var g,h,k,l,m,n=t.hasData(a)&&t.get(a);if(n&&(k=n.events)){b=(b||"").match(R)||[""];for(l=b.length;l--;){var p=Hb.exec(b[l])||[],r=m=p[1],u=(p[2]||"").split(".").sort();if(r){var q=d.event.special[r]||{};r=(e?q.delegateType:q.bindType)||r;var v=k[r]||[];p=p[2]&&new RegExp("(^|\\.)"+u.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=v.length;g--;){var x=
v[g];!f&&m!==x.origType||c&&c.guid!==x.guid||p&&!p.test(x.namespace)||e&&e!==x.selector&&("**"!==e||!x.selector)||(v.splice(g,1),x.selector&&v.delegateCount--,q.remove&&q.remove.call(a,x))}h&&!v.length&&(q.teardown&&!1!==q.teardown.call(a,u,n.handle)||d.removeEvent(a,r,n.handle),delete k[r])}else for(r in k)d.event.remove(a,r+b[l],c,e,!0)}d.isEmptyObject(k)&&t.remove(a,"handle events")}},dispatch:function(a){var b,c,e,f=Array(arguments.length),g=d.event.fix(a),h=(t.get(this,"events")||Object.create(null))[g.type]||
[],k=d.event.special[g.type]||{};f[0]=g;for(b=1;b<arguments.length;b++)f[b]=arguments[b];g.delegateTarget=this;if(!k.preDispatch||!1!==k.preDispatch.call(this,g)){var l=d.event.handlers.call(this,g,h);for(b=0;(e=l[b++])&&!g.isPropagationStopped();)for(g.currentTarget=e.elem,h=0;(c=e.handlers[h++])&&!g.isImmediatePropagationStopped();)if(!g.rnamespace||!1===c.namespace||g.rnamespace.test(c.namespace))g.handleObj=c,g.data=c.data,c=((d.event.special[c.origType]||{}).handle||c.handler).apply(e.elem,f),
void 0!==c&&!1===(g.result=c)&&(g.preventDefault(),g.stopPropagation());k.postDispatch&&k.postDispatch.call(this,g);return g.result}},handlers:function(a,b){var c,e=[],f=b.delegateCount,g=a.target;if(f&&g.nodeType&&!("click"===a.type&&1<=a.button))for(;g!==this;g=g.parentNode||this)if(1===g.nodeType&&("click"!==a.type||!0!==g.disabled)){var h=[],k={};for(c=0;c<f;c++){var l=b[c],m=l.selector+" ";void 0===k[m]&&(k[m]=l.needsContext?-1<d(m,this).index(g):d.find(m,this,null,[g]).length);k[m]&&h.push(l)}h.length&&
e.push({elem:g,handlers:h})}f<b.length&&e.push({elem:this,handlers:b.slice(f)});return e},addProp:function(a,b){Object.defineProperty(d.Event.prototype,a,{enumerable:!0,configurable:!0,get:q(b)?function(){if(this.originalEvent)return b(this.originalEvent)}:function(){if(this.originalEvent)return this.originalEvent[a]},set:function(b){Object.defineProperty(this,a,{enumerable:!0,configurable:!0,writable:!0,value:b})}})},fix:function(a){return a[d.expando]?a:new d.Event(a)},special:{load:{noBubble:!0},
...
/<script|<style|<link/i,cc=/checked\s*(?:[^=]|=\s*.checked.)/i,dc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;d.extend({htmlPrefilter:function(a){return a},clone:function(a,b,c){var e,f=a.cloneNode(!0),g=ba(a);if(!(x.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){var h=F(f),k=F(a),l=0;for(e=k.length;l<e;l++){var m=k[l],n=h[l],p=n.nodeName.toLowerCase();if("input"===p&&ta.test(m.type))n.checked=m.checked;else if("input"===p||"textarea"===p)n.defaultValue=m.defaultValue}}if(b)if(c)for(k=
k||F(a),h=h||F(f),l=0,e=k.length;l<e;l++)ob(k[l],h[l]);else ob(a,f);h=F(f,"script");0<h.length&&Pa(h,!g&&F(a,"script"));return f},cleanData:function(a){for(var b,c,e,f=d.event.special,g=0;void 0!==(c=a[g]);g++)if(ha(c)){if(b=c[t.expando]){if(b.events)for(e in b.events)f[e]?d.event.remove(c,e):d.removeEvent(c,e,b.handle);c[t.expando]=void 0}c[B.expando]&&(c[B.expando]=void 0)}}});d.fn.extend({detach:function(a){return qb(this,a,!0)},remove:function(a){return qb(this,a)},text:function(a){return O(this,
function(a){return void 0===a?d.text(this):this.empty().each(function(){if(1===this.nodeType||11===this.nodeType||9===this.nodeType)this.textContent=a})},null,a,arguments.length)},append:function(){return oa(this,arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||nb(this,a).appendChild(a)})},prepend:function(){return oa(this,arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=nb(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return oa(this,
...
ec=new RegExp(T.join("|"),"i");(function(){function a(){if(l){k.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0";l.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%";ia.appendChild(k).appendChild(l);var a=u.getComputedStyle(l);b="1%"!==a.top;h=12===Math.round(parseFloat(a.marginLeft));l.style.right="60%";f=36===Math.round(parseFloat(a.right));c=36===Math.round(parseFloat(a.width));
...
this.now,this);c&&c.set?c.set(this):I.propHooks._default.set(this);return this}};I.prototype.init.prototype=I.prototype;I.propHooks={_default:{get:function(a){return 1!==a.elem.nodeType||null!=a.elem[a.prop]&&null==a.elem.style[a.prop]?a.elem[a.prop]:(a=d.css(a.elem,a.prop,""))&&"auto"!==a?a:0},set:function(a){if(d.fx.step[a.prop])d.fx.step[a.prop](a);else 1!==a.elem.nodeType||!d.cssHooks[a.prop]&&null==a.elem.style[Sa(a.prop)]?a.elem[a.prop]=a.now:d.style(a.elem,a.prop,a.now+a.unit)}}};I.propHooks.scrollTop=
I.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};d.fx=I.prototype.init;d.fx.step={};var Y,Ka,wc=/^(?:toggle|show|hide)$/,xc=/queueHooks$/;d.Animation=d.extend(C,{tweeners:{"*":[function(a,b){var c=this.createTween(a,b);ib(c.elem,a,X.exec(b),c);return c}]},tweener:function(a,b){q(a)?(b=a,a=["*"]):a=a.match(R);for(var c,d=0,f=a.length;d<f;d++)c=
a[d],C.tweeners[c]=C.tweeners[c]||[],C.tweeners[c].unshift(b)},prefilters:[function(a,b,c){var e,f="width"in b||"height"in b,g=this,h={},k=a.style,l=a.nodeType&&Ea(a),m=t.get(a,"fxshow");if(!c.queue){var n=d._queueHooks(a,"fx");if(null==n.unqueued){n.unqueued=0;var p=n.empty.fire;n.empty.fire=function(){n.unqueued||p()}}n.unqueued++;g.always(function(){g.always(function(){n.unqueued--;d.queue(a,"fx").length||n.empty.fire()})})}for(e in b){var r=b[e];if(wc.test(r)){delete b[e];var u=u||"toggle"===
r;if(r===(l?"hide":"show"))if("show"===r&&m&&void 0!==m[e])l=!0;else continue;h[e]=m&&m[e]||d.style(a,e)}}if((b=!d.isEmptyObject(b))||!d.isEmptyObject(h)){if(f&&1===a.nodeType){c.overflow=[k.overflow,k.overflowX,k.overflowY];var q=m&&m.display;null==q&&(q=t.get(a,"display"));f=d.css(a,"display");"none"===f&&(q?f=q:(la([a],!0),q=a.style.display||q,f=d.css(a,"display"),la([a])));("inline"===f||"inline-block"===f&&null!=q)&&"none"===d.css(a,"float")&&(b||(g.done(function(){k.display=q}),null==q&&(f=
k.display,q="none"===f?"":f)),k.display="inline-block")}c.overflow&&(k.overflow="hidden",g.always(function(){k.overflow=c.overflow[0];k.overflowX=c.overflow[1];k.overflowY=c.overflow[2]}));b=!1;for(e in h)b||(m?"hidden"in m&&(l=m.hidden):m=t.access(a,"fxshow",{display:q}),u&&(m.hidden=!l),l&&la([a],!0),g.done(function(){l||la([a]);t.remove(a,"fxshow");for(e in h)d.style(a,e,h[e])})),b=yb(l?m[e]:0,e,g),e in m||(m[e]=b.start,l&&(b.end=b.start,b.start=0))}}],prefilter:function(a,b){b?C.prefilters.unshift(a):
...
k[g].stop&&e(k[g]);else for(g in k)k[g]&&k[g].stop&&xc.test(g)&&e(k[g]);for(g=h.length;g--;)h[g].elem!==this||null!=a&&h[g].queue!==a||(h[g].anim.stop(c),b=!1,h.splice(g,1));!b&&c||d.dequeue(this,a)})},finish:function(a){!1!==a&&(a=a||"fx");return this.each(function(){var b=t.get(this),c=b[a+"queue"],e=b[a+"queueHooks"],f=d.timers,g=c?c.length:0;b.finish=!0;d.queue(this,a,[]);e&&e.stop&&e.stop.call(this,!0);for(e=f.length;e--;)f[e].elem===this&&f[e].queue===a&&(f[e].anim.stop(!0),f.splice(e,1));for(e=
0;e<g;e++)c[e]&&c[e].finish&&c[e].finish.call(this);delete b.finish})}});d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,g){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(La(b,!0),a,d,g)}});d.each({slideDown:La("show"),slideUp:La("hide"),slideToggle:La("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){d.fn[a]=function(a,d,f){return this.animate(b,a,d,f)}});d.timers=[];d.fx.tick=function(){var a=
0,b=d.timers;for(Y=Date.now();a<b.length;a++){var c=b[a];c()||b[a]!==c||b.splice(a--,1)}b.length||d.fx.stop();Y=void 0};d.fx.timer=function(a){d.timers.push(a);d.fx.start()};d.fx.interval=13;d.fx.start=function(){Ka||(Ka=!0,Ua())};d.fx.stop=function(){Ka=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fn.delay=function(a,b){a=d.fx?d.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,d){var c=u.setTimeout(b,a);d.stop=function(){u.clearTimeout(c)}})};(function(){var a=v.createElement("input"),
...
-1<d.inArray(d(a).val(),b)}};x.checkOn||(d.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});x.focusin="onfocusin"in u;var Lb=/^(?:focusinfocus|focusoutblur)$/,Mb=function(a){a.stopPropagation()};d.extend(d.event,{trigger:function(a,b,c,e){var f,g,h,k=[c||v],l=Ma.call(a,"type")?a.type:a,m=Ma.call(a,"namespace")?a.namespace.split("."):[],n=h=f=c=c||v;if(3!==c.nodeType&&8!==c.nodeType&&!Lb.test(l+d.event.triggered)){-1<l.indexOf(".")&&(m=l.split("."),l=m.shift(),
m.sort());var p=0>l.indexOf(":")&&"on"+l;a=a[d.expando]?a:new d.Event(l,"object"===typeof a&&a);a.isTrigger=e?2:3;a.namespace=m.join(".");a.rnamespace=a.namespace?new RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"):null;a.result=void 0;a.target||(a.target=c);b=null==b?[a]:d.makeArray(b,[a]);m=d.event.special[l]||{};if(e||!m.trigger||!1!==m.trigger.apply(c,b)){if(!e&&!m.noBubble&&!ja(c)){var r=m.delegateType||l;for(Lb.test(r+l)||(n=n.parentNode);n;n=n.parentNode)k.push(n),f=n;f===(c.ownerDocument||
v)&&k.push(f.defaultView||f.parentWindow||u)}for(f=0;(n=k[f++])&&!a.isPropagationStopped();)h=n,a.type=1<f?r:m.bindType||l,(g=(t.get(n,"events")||Object.create(null))[a.type]&&t.get(n,"handle"))&&g.apply(n,b),(g=p&&n[p])&&g.apply&&ha(n)&&(a.result=g.apply(n,b),!1===a.result&&a.preventDefault());a.type=l;e||a.isDefaultPrevented()||m._default&&!1!==m._default.apply(k.pop(),b)||!ha(c)||!p||!q(c[l])||ja(c)||((f=c[p])&&(c[p]=null),d.event.triggered=l,a.isPropagationStopped()&&h.addEventListener(l,Mb),
c[l](),a.isPropagationStopped()&&h.removeEventListener(l,Mb),d.event.triggered=void 0,f&&(c[p]=f));return a.result}}},simulate:function(a,b,c){a=d.extend(new d.Event,c,{type:a,isSimulated:!0});d.event.trigger(a,null,b)}});d.fn.extend({trigger:function(a,b){return this.each(function(){d.event.trigger(a,b,this)})},triggerHandler:function(a,b){var c=this[0];if(c)return d.event.trigger(a,b,c,!0)}});x.focusin||d.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){d.event.simulate(b,
a.target,d.event.fix(a))};d.event.special[b]={setup:function(){var d=this.ownerDocument||this.document||this,f=t.access(d,b);f||d.addEventListener(a,c,!0);t.access(d,b,(f||0)+1)},teardown:function(){var d=this.ownerDocument||this.document||this,f=t.access(d,b)-1;f?t.access(d,b,f):(d.removeEventListener(a,c,!0),t.remove(d,b))}}});var va=u.location,Nb=Date.now(),ab=/\?/;d.parseXML=function(a){if(!a||"string"!==typeof a)return null;try{var b=(new u.DOMParser).parseFromString(a,"text/xml")}catch(c){b=
void 0}b&&!b.getElementsByTagName("parsererror").length||d.error("Invalid XML: "+a);return b};var gc=/\[\]$/,Ob=/\r?\n/g,Cc=/^(?:submit|button|image|reset|file)$/i,Dc=/^(?:input|select|textarea|keygen)/i;d.param=function(a,b){var c,e=[],f=function(a,b){b=q(b)?b():b;e[e.length]=encodeURIComponent(a)+"\x3d"+encodeURIComponent(null==b?"":b)};if(null==a)return"";if(Array.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){f(this.name,this.value)});else for(c in a)Wa(c,a[c],b,f);return e.join("\x26")};
...
"\r\n")}}).get()}});var Ec=/%20/g,Fc=/#.*$/,Gc=/([?&])_=[^&]*/,Hc=/^(.*?):[ \t]*([^\r\n]*)$/mg,Ic=/^(?:GET|HEAD)$/,Jc=/^\/\//,Pb={},Xa={},Qb="*/".concat("*"),bb=v.createElement("a");bb.href=va.href;d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:va.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(va.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset\x3dUTF-8",accepts:{"*":Qb,text:"text/plain",html:"text/html",
xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":d.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?Ya(Ya(a,d.ajaxSettings),b):Ya(d.ajaxSettings,a)},ajaxPrefilter:zb(Pb),ajaxTransport:zb(Xa),ajax:function(a,b){function c(a,b,c,g){var l,v=b;if(!C){C=
!0;h&&u.clearTimeout(h);e=void 0;f=g||"";z.readyState=0<a?4:0;g=200<=a&&300>a||304===a;c&&(l=hc(m,z,c));!g&&-1<d.inArray("script",m.dataTypes)&&(m.converters["text script"]=function(){});l=ic(m,l,z,g);if(g)if(m.ifModified&&((c=z.getResponseHeader("Last-Modified"))&&(d.lastModified[B]=c),(c=z.getResponseHeader("etag"))&&(d.etag[B]=c)),204===a||"HEAD"===m.type)v="nocontent";else if(304===a)v="notmodified";else{v=l.state;var x=l.data,A=l.error;g=!A}else if(A=v,a||!v)v="error",0>a&&(a=0);z.status=a;z.statusText=
(b||v)+"";g?r.resolveWith(n,[x,v,z]):r.rejectWith(n,[z,v,A]);z.statusCode(t);t=void 0;k&&p.trigger(g?"ajaxSuccess":"ajaxError",[z,m,g?x:A]);q.fireWith(n,[z,v]);k&&(p.trigger("ajaxComplete",[z,m]),--d.active||d.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,k,l,m=d.ajaxSetup({},b),n=m.context||m,p=m.context&&(n.nodeType||n.jquery)?d(n):d.event,r=d.Deferred(),q=d.Callbacks("once memory"),t=m.statusCode||{},x={},E={},F="canceled",z={readyState:0,getResponseHeader:function(a){var b;
if(C){if(!g)for(g={};b=Hc.exec(f);)g[b[1].toLowerCase()+" "]=(g[b[1].toLowerCase()+" "]||[]).concat(b[2]);b=g[a.toLowerCase()+" "]}return null==b?null:b.join(", ")},getAllResponseHeaders:function(){return C?f:null},setRequestHeader:function(a,b){null==C&&(a=E[a.toLowerCase()]=E[a.toLowerCase()]||a,x[a]=b);return this},overrideMimeType:function(a){null==C&&(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(C)z.always(a[z.status]);else for(b in a)t[b]=[t[b],a[b]];return this},abort:function(a){a=
a||F;e&&e.abort(a);c(0,a);return this}};r.promise(z);m.url=((a||m.url||va.href)+"").replace(Jc,va.protocol+"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=(m.dataType||"*").toLowerCase().match(R)||[""];if(null==m.crossDomain){a=v.createElement("a");try{a.href=m.url,a.href=a.href,m.crossDomain=bb.protocol+"//"+bb.host!==a.protocol+"//"+a.host}catch(qa){m.crossDomain=!0}}m.data&&m.processData&&"string"!==typeof m.data&&(m.data=d.param(m.data,m.traditional));Ab(Pb,m,b,z);if(C)return z;(k=
d.event&&m.global)&&0===d.active++&&d.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!Ic.test(m.type);var B=m.url.replace(Fc,"");m.hasContent?m.data&&m.processData&&0===(m.contentType||"").indexOf("application/x-www-form-urlencoded")&&(m.data=m.data.replace(Ec,"+")):(a=m.url.slice(B.length),m.data&&(m.processData||"string"===typeof m.data)&&(B+=(ab.test(B)?"\x26":"?")+m.data,delete m.data),!1===m.cache&&(B=B.replace(Gc,"$1"),a=(ab.test(B)?"\x26":"?")+"_\x3d"+Nb++ +a),m.url=B+
a);m.ifModified&&(d.lastModified[B]&&z.setRequestHeader("If-Modified-Since",d.lastModified[B]),d.etag[B]&&z.setRequestHeader("If-None-Match",d.etag[B]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&z.setRequestHeader("Content-Type",m.contentType);z.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Qb+"; q\x3d0.01":""):m.accepts["*"]);for(l in m.headers)z.setRequestHeader(l,m.headers[l]);if(m.beforeSend&&(!1===m.beforeSend.call(n,
z,m)||C))return z.abort();F="abort";q.add(m.complete);z.done(m.success);z.fail(m.error);if(e=Ab(Xa,m,b,z)){z.readyState=1;k&&p.trigger("ajaxSend",[z,m]);if(C)return z;m.async&&0<m.timeout&&(h=u.setTimeout(function(){z.abort("timeout")},m.timeout));try{var C=!1;e.send(x,c)}catch(qa){if(C)throw qa;c(-1,qa)}}else c(-1,"No Transport");return z},getJSON:function(a,b,c){return d.get(a,b,c,"json")},getScript:function(a,b){return d.get(a,void 0,b,"script")}});d.each(["get","post"],function(a,b){d[b]=function(a,
...
abort:function(){c&&c()}}}});var Rb=[],cb=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Rb.pop()||d.expando+"_"+Nb++;this[a]=!0;return a}});d.ajaxPrefilter("json jsonp",function(a,b,c){var e,f=!1!==a.jsonp&&(cb.test(a.url)?"url":"string"===typeof a.data&&0===(a.contentType||"").indexOf("application/x-www-form-urlencoded")&&cb.test(a.data)&&"data");if(f||"jsonp"===a.dataTypes[0]){var g=a.jsonpCallback=q(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback;f?a[f]=a[f].replace(cb,
"$1"+g):!1!==a.jsonp&&(a.url+=(ab.test(a.url)?"\x26":"?")+a.jsonp+"\x3d"+g);a.converters["script json"]=function(){e||d.error(g+" was not called");return e[0]};a.dataTypes[0]="json";var h=u[g];u[g]=function(){e=arguments};c.always(function(){void 0===h?d(u).removeProp(g):u[g]=h;a[g]&&(a.jsonpCallback=b.jsonpCallback,Rb.push(g));e&&q(h)&&h(e[0]);e=h=void 0});return"script"}});x.createHTMLDocument=function(){var a=v.implementation.createHTMLDocument("").body;a.innerHTML="\x3cform\x3e\x3c/form\x3e\x3cform\x3e\x3c/form\x3e";
return 2===a.childNodes.length}();d.parseHTML=function(a,b,c){if("string"!==typeof a)return[];"boolean"===typeof b&&(c=b,b=!1);if(!b)if(x.createHTMLDocument){b=v.implementation.createHTMLDocument("");var e=b.createElement("base");e.href=v.location.href;b.head.appendChild(e)}else b=v;e=Fb.exec(a);c=!c&&[];if(e)return[b.createElement(e[1])];e=kb([a],b,c);c&&c.length&&d(c).remove();return d.merge([],e.childNodes)};d.fn.load=function(a,b,c){var e,f,g=this,h=a.indexOf(" ");if(-1<h){var k=ca(a.slice(h));
...
function(a,b){d.fn[b]=function(a,d){return 0<arguments.length?this.on(b,null,a,d):this.trigger(b)}});var Lc=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;d.proxy=function(a,b){if("string"===typeof b){var c=a[b];b=a;a=c}if(q(a)){var e=S.call(arguments,2);c=function(){return a.apply(b||this,e.concat(S.call(arguments)))};c.guid=a.guid=a.guid||d.guid++;return c}};d.holdReady=function(a){a?d.readyWait++:d.ready(!0)};d.isArray=Array.isArray;d.parseJSON=JSON.parse;d.nodeName=K;d.isFunction=q;d.isWindow=ja;d.camelCase=
P;d.type=Z;d.now=Date.now;d.isNumeric=function(a){var b=d.type(a);return("number"===b||"string"===b)&&!isNaN(a-parseFloat(a))};d.trim=function(a){return null==a?"":(a+"").replace(Lc,"")};"function"===typeof define&&define.amd&&define("jquery",[],function(){return d});var Mc=u.jQuery,Nc=u.$;d.noConflict=function(a){u.$===d&&(u.$=Nc);a&&u.jQuery===d&&(u.jQuery=Mc);return d};"undefined"===typeof wa&&(u.jQuery=u.$=d);return d});