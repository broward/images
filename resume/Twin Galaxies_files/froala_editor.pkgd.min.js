...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.7.6", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
    ...
    if (a.FE.LinkRegExCommon = "[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExWWW + "|" + a.FE.LinkRegExAuth + ")" + a.FE.LinkRegExEnd, a.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function(b) {
            ...
            function o(b) {
                return /^(https?:|ftps?:|)\/\//i.test(b) ? !1 : a.FE.MAIL_REGEX.test(b)
            }
            ...
            function e(a) {
                return a ? a.nodeType != Node.ELEMENT_NODE ? !1 : "a" == a.tagName.toLowerCase() : !1
            }
            ...
            function o(a, c) {
                ...
                return d ? d.nodeType == Node.TEXT_NODE && "" === d.textContent ? o(d) : !1 : !0
            }
            ...
            function y(c, d) {
                ...
                return e ? (b.node.isBlock(e) ? x(e) : "BR" == e.tagName ? a(e).before(a.FE.MARKERS) : a(e).after(a.FE.MARKERS), !0) : d ? (b.node.isBlock(c) ? w(c) : a(c).before(a.FE.MARKERS), !0) : !1
            }

            function z(c, d) {
                "undefined" == typeof d && (d = !0);
                for (var e = c.nextSibling; e && e.nodeType == Node.TEXT_NODE && 0 === e.textContent.length;) e = e.nextSibling;
                return e ? (b.node.isBlock(e) ? w(e) : a(e).before(a.FE.MARKERS), !0) : d ? (b.node.isBlock(c) ? x(c) : a(c).after(a.FE.MARKERS), !0) : !1
            }
            return {
                text: c,
                get: d,
            ...
            function j(a, c) {
                var e, f = document.implementation.createHTMLDocument("Froala DOC"),
            ...
            function E(a, c) {
                ...
                var e, f, g = [],
                    h = {},
                    i = [],
                    j = b.el.querySelectorAll("input, textarea");
                ...
                if (!b.opts.useClasses && !c) {
                    ...
                    for (e = 0; e < b.doc.styleSheets.length; e++) {
                        ...
                        if (l)
                            for (var o = 0, p = l.length; p > o; o++)
                                if (l[o].selectorText && l[o].style.cssText.length > 0) {
                ...
                if (b.node.isEmpty(b.el)) b.opts.fullPage && (d = r(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.find("head").get(0).outerHTML + "<body></body></html>");
                else if ("undefined" == typeof a && (a = !1), b.opts.fullPage) {
            ...
            function K(c, d, e) {
                b.selection.isCollapsed() || b.selection.remove();
                var f;
                if (f = d ? c : b.clean.html(c), c.indexOf('class="fr-marker"') < 0 && (f = H(f)), b.node.isEmpty(b.el) && !b.opts.keepFormatOnDelete && G(f)) b.el.innerHTML = f;
                else {
            ...
            function d() {
                return a.$wp ? (c(), void(a.$iframe && (a.events.on("keyup keydown", function() {
                    setTimeout(b, 0)
                }, !0), a.events.on("commands.after html.set init initialized paste.after", b)))) : !1
            }
            return {
                _init: d,
                syncIframe: b,
            ...
            function f(a, c) {
                return a ? a == b.$wp.get(0) ? !1 : a.nextSibling && a.nextSibling.nodeType == Node.TEXT_NODE && 0 === a.nextSibling.textContent.replace(/\u200b/g, "").length ? f(a.nextSibling, c) : !a.nextSibling || a.previousSibling && "BR" == a.nextSibling.tagName && !a.nextSibling.nextSibling ? a.parentNode == c ? !0 : f(a.parentNode, c) : !1 : !1
            }
                    ...
                    if (b.node.isBlock(e) && b.node.isEditable(e) && i && a.FE.NO_DELETE_TAGS.indexOf(i.tagName) < 0)
                        ...
                        if (b.node.isBlock(i))
                            if (b.node.isEmpty(i) && !b.node.isList(i)) a(i).remove(), a(c).after(b.opts.keepFormatOnDelete ? a.FE.INVISIBLE_SPACE : "");
                                ...
                                if (b.node.isEmpty(e)) a(c).remove(), b.selection.setAtEnd(i, !0);
                                else {
            ...
            function p(i) {
                ...
                H = !1;
                var m = v(l) && !t(i) && !i.altKey,
                    n = l == a.FE.KEYCODE.BACKSPACE || l == a.FE.KEYCODE.DELETE;
            ...
            function w(c) {
                var d = c.which;
                return t(c) || d >= 37 && 40 >= d || !v(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && d != a.FE.KEYCODE.IME ? !0 : (F || (G = b.snapshot.get(), b.undo.canDo() || b.undo.saveStep()), clearTimeout(F), void(F = setTimeout(function() {
            ...
            function x(a) {
                var c = a.which;
                return t(a) || c >= 37 && 40 >= c ? !0 : void(G && F ? (b.undo.saveStep(G), G = null) : "undefined" != typeof c && 0 !== c || G || F || b.undo.saveStep())
            }
            ...
            function B(c) {
                var d = b.el.childNodes,
                    e = b.html.defaultTag();
                return c.target && c.target !== b.el ? !0 : 0 === d.length ? !0 : void(b.$el.outerHeight() - c.offsetY <= 10 ? A(d[d.length - 1]) && (e ? b.$el.append("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.append(a.FE.MARKERS + "<br>"), b.selection.restore(), r()) : c.offsetY <= 10 && A(d[0]) && (e ? b.$el.prepend("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.prepend(a.FE.MARKERS + "<br>"), b.selection.restore(), r()))
            }
            ...
            function g(a) {
                return a && "block" !== a.css("display") ? (a.remove(), !0) : !1
            }
            ...
            var l, m, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
                o = function() {
            ...
            function l(c, d, e) {
                ...
                if ("string" == typeof u && (c = u), "" !== c) {
                    ...
                    if (b.opts.enter == a.FE.ENTER_BR)
                        for (g = v.querySelectorAll("p, div"), f = g.length - 1; f >= 0; f--) j = g[f], 0 === j.attributes.length && (j.outerHTML = j.innerHTML + (j.nextSibling && !b.node.isEmpty(j) ? "<br>" : ""));
                    else if (b.opts.enter == a.FE.ENTER_DIV)
                        for (g = v.getElementsByTagName("p"), f = g.length - 1; f >= 0; f--) j = g[f], 0 === j.attributes.length && (j.outerHTML = "<div>" + j.innerHTML + "</div>");
                    else b.opts.enter == a.FE.ENTER_P && 1 == v.childNodes.length && "P" == v.childNodes[0].tagName && 0 === v.childNodes[0].attributes.length && (v.childNodes[0].outerHTML = v.childNodes[0].innerHTML);
            ...
            iconsTemplate: a.FE.ICON_DEFAULT_TEMPLATE || "font_awesome"
            ...
            function c() {
                return b.helpers.isMobile() ? !1 : void(b.$tooltip && b.$tooltip.removeClass("fr-visible").css("left", "-3000px").css("position", "fixed"))
            }
            ...
            function r(c) {
                ...
                return b.events.trigger("buttons.refresh") === !1 ? !0 : void setTimeout(function() {
            ...
            function e(c, e, f) {
                if (b.shared.$overlay || (b.shared.$overlay = a('<div class="fr-overlay">').appendTo("body:first")), m = b.shared.$overlay, b.opts.theme && m.addClass(b.opts.theme + "-theme"), !n[c]) {
                    ...
                    n[c] = {
                        ...
                        var e = d.which;
                        return e == a.FE.KEYCODE.ESC ? (h(c), b.accessibility.focusModalButton(g), !1) : a(d.currentTarget).is("input[type=text], textarea") || e == a.FE.KEYCODE.ARROW_UP || e == a.FE.KEYCODE.ARROW_DOWN || b.keys.isBrowserAction(d) ? !0 : (d.preventDefault(), d.stopPropagation(), !1)
                    }, !0), h(c, !0)
                }
                return n[c]
            }
                    ...
                    _repositionPopup: function() {
                        ...
                        if (b.$wp && f(c) && d.parent().get(0) == b.$sc.get(0)) {
                            var a = d.offset().top - b.$wp.offset().top,
                                e = b.$wp.outerHeight();
                            b.node.hasClass(d.get(0), "fr-above") && (a += d.outerHeight()), a > e || 0 > a ? d.addClass("fr-hidden") : d.removeClass("fr-hidden")
                        }
                    }
                }
            }
            ...
            function e(a, c) {
                ...
                return c + d > b.$sc.get(0).clientWidth - 10 && (c = b.$sc.get(0).clientWidth - d - 10), 0 > c && (c = 10), c
            }
            ...
            function k() {
                if (!j())
                    if (b._stickyElements = [], b.helpers.isIOS()) {
                        var c = function() {
                            if (b.helpers.requestAnimationFrame()(c), b.events.trigger("position.refresh") !== !1)
            ...
            function i(a) {
                ...
                return c.next().find(b.o_doc.activeElement).length ? !0 : void(b.events.trigger("toolbar.hide") !== !1 && b.$tb.hide())
            }

            function j() {
                return b.events.trigger("toolbar.show") === !1 ? !1 : void b.$tb.show()
            }
            ...
            function q() {
                ...
                }, !0), b.opts.toolbarInline = !1) : b.opts.toolbarInline ? (b.$box.addClass("fr-inline"), b.shared.$tb ? (b.$tb = b.shared.$tb, l()) : (b.shared.$tb = a('<div class="fr-toolbar"></div>'), b.$tb = b.shared.$tb, p())) : (b.$box.addClass("fr-basic"), b.$tb = a('<div class="fr-toolbar"></div>'), p(), b.$tb.data("instance", b)), b.events.on("destroy", o, !0), void b.events.on(b.opts.toolbarInline || b.opts.toolbarContainer ? "shared.destroy" : "destroy", n, !0)) : !1
            }
            ...
            function c(c) {
                var d = b.selection.element();
                if (a(d).parents(".fr-img-caption").length) a(d).css("text-align", c);
                else {
                    b.selection.save(), b.html.wrap(!0, !0, !0, !0), b.selection.restore();
                    for (var e = b.selection.blocks(), f = 0; f < e.length; f++) b.helpers.getAlignment(a(e[f].parentNode)) == c ? a(e[f]).css("text-align", "").removeClass("fr-temp-div") : a(e[f]).css("text-align", c).removeClass("fr-temp-div"), "" === a(e[f]).attr("class") && a(e[f]).removeAttr("class"), "" === a(e[f]).attr("style") && a(e[f]).removeAttr("style");
                    b.selection.save(), b.html.unwrap(), b.selection.restore()
                }
            }
            ...
            function d(d) {
                ...
                var e = d.which;
                return !b.keys.ctrlKey(d) && b.keys.isCharacter(e) || e === a.FE.KEYCODE.IME ? (d.preventDefault(), d.stopPropagation(), b.events.trigger("charCounter.exceeded"), !1) : !0
            }
            ...
            function d() {
                return m ? m.getValue() : l.val()
            }

            function e() {
                c() && (m.setSize(null, b.opts.height ? b.opts.height : "auto"), b.opts.heightMin || b.opts.height ? b.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", b.opts.heightMin || b.opts.height) : b.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", ""))
            }
            ...
            function g(c) {
                l || (j(), !m && b.opts.codeMirror ? m = b.opts.codeMirror.fromTextArea(l.get(0), b.opts.codeMirrorOptions) : b.events.$on(l, "keydown keyup change input", function() {
                ...
                if (m) {
                    ...
                    e = d.substring(0, e).length - d.substring(0, d.substring(0, e).lastIndexOf("\n") + 1).length, f = d.substring(0, f).length - d.substring(0, d.substring(0, f).lastIndexOf("\n") + 1).length, m.setSize(null, b.opts.height ? b.opts.height : "auto"), b.opts.heightMin && b.$box.find(".CodeMirror-scroll").css("min-height", b.opts.heightMin), m.setValue(d), m.focus(), m.setSelection({
                        line: g,
                        ch: e
                    }, {
                        line: h,
                        ch: f
                    }), m.refresh(), m.clearHistory()
                } else {
                    e = d.indexOf("FROALA-SM"), f = d.indexOf("FROALA-EM") - 9, b.opts.heightMin && l.css("min-height", b.opts.heightMin), b.opts.height && l.css("height", b.opts.height), b.opts.heightMax && l.css("max-height", b.opts.height || b.opts.heightMax), l.val(d.replace(/FROALA-SM/g, "").replace(/FROALA-EM/g, "")).trigger("change");
                    var i = a(b.o_doc).scrollTop();
                    l.focus(), l.get(0).setSelectionRange(e, f), a(b.o_doc).scrollTop(i)
                }
            ...
            function h(a) {
                ...
                a ? (b.popups.hideAll(), g(d)) : (b.$box.toggleClass("fr-code-view", !1), f(d))
            }

            function i() {
                c() && h(!1), m && m.toTextArea(), l.val("").removeData().remove(), l = null, n && (n.remove(), n = null)
            }

            function j() {
                l = a('<textarea class="fr-code" tabIndex="-1">'), b.$wp.append(l), l.attr("dir", b.opts.direction), b.$box.hasClass("fr-basic") || (n = a('<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch' + (b.helpers.isMobile() ? "" : " fr-desktop") + '" role="button" tabIndex="-1"><i class="fa fa-code"></i></button>'), b.$box.append(n), b.events.bindClick(b.$box, "a.html-switch", function() {
                    h(!1)
                }));
                var f = function() {
                    return !c()
                };
                b.events.on("buttons.refresh", f), b.events.on("copy", f, !0), b.events.on("cut", f, !0), b.events.on("paste", f, !0), b.events.on("destroy", i, !0), b.events.on("html.set", function() {
                    c() && h(!0)
                }), b.events.on("codeView.update", e), b.events.on("form.submit", function() {
            ...
            function h(c) {
                b.events.on("popup.tab", function(d) {
                    ...
                    if (a.FE.KEYCODE.TAB == f) {
                        ...
                        g = !b.accessibility.focusToolbar(h, d.shiftKey ? !0 : !1)
            ...
            function c(c) {
                return c.originalEvent && c.originalEvent.target && c.originalEvent.target.nodeType == Node.TEXT_NODE ? !0 : (c.target && "A" == c.target.tagName && 1 == c.target.childNodes.length && "IMG" == c.target.childNodes[0].tagName && (c.target = c.target.childNodes[0]), a(c.target).hasClass("fr-draggable") ? (b.undo.canDo() || b.undo.saveStep(), b.opts.dragInline ? b.$el.attr("contenteditable", !0) : b.$el.attr("contenteditable", !1), b.opts.toolbarInline && b.toolbar.hide(), a(c.target).addClass("fr-dragging"), b.browser.msie || b.browser.edge || b.selection.clear(), void c.originalEvent.dataTransfer.setData("text", "Froala")) : (c.preventDefault(), !1))
            }
            ...
            function f(c) {
                ...
                if (!d(f)) {
                    ...
                    (!d(j) || n && 0 === b.$el.find(j).length && j != n.get(0)) && (j = null), f = null == j && h ? h : j && null == h ? j : j && h ? i > g ? h : j : null
                }
            ...
            function k(c) {
                ...
                if (d.length) {
                    ...
                    var h = d;
                    if (d.parent().is("A") && 1 == d.parent().get(0).childNodes.length && (h = d.parent()), b.core.isEmpty()) b.events.focus();
                    else {
                    ...
                    if (e == b || b.undo.canDo() || b.undo.saveStep(), b.core.isEmpty()) b.$el.html(h);
                        ...
                        0 === h.find(j).length ? a(j).replaceWith(h) : 0 === d.find(j).length && a(j).replaceWith(d), d.after(a.FE.MARKERS), b.selection.restore()
                    }
                ...
                b.events.on("popup.tab", function(d) {
                    ...
                    if (a.FE.KEYCODE.TAB == i) {
                        if (e.is("span.fr-emoticon") && d.shiftKey || e.is("a") && !d.shiftKey) {
                            ...
                            f = !b.accessibility.focusToolbar(j, d.shiftKey ? !0 : !1)
                        }
                        if (f !== !1) {
            ...
            function d() {
                if (b.helpers.isIOS() && b.core.hasFocus()) return b.$el.blur(), setTimeout(f, 250), !1;
                i = b.helpers.scrollTop(), b.$box.toggleClass("fr-fullscreen"), a("body:first").toggleClass("fr-fullscreen"), b.helpers.isMobile() && (b.$tb.data("parent", b.$tb.parent()), b.$tb.prependTo(b.$box), b.$tb.data("sticky-dummy") && b.$tb.after(b.$tb.data("sticky-dummy"))), j = b.opts.height, k = b.opts.heightMax, l = b.opts.zIndex, b.position.refresh(), b.opts.height = b.o_win.innerHeight - (b.opts.toolbarInline ? 0 : b.$tb.outerHeight()), b.opts.zIndex = 2147483641, b.opts.heightMax = null, b.size.refresh(), b.opts.toolbarInline && b.toolbar.showInline();
                ...
                b.opts.toolbarContainer && b.$box.prepend(b.$tb), b.events.trigger("charCounter.update"), b.events.trigger("codeView.update"), b.$win.trigger("scroll")
            }
            ...
            function e() {
                ...
                b.opts.toolbarContainer && a(b.opts.toolbarContainer).append(b.$tb), a(b.o_win).trigger("scroll"), b.events.trigger("codeView.update")
            }
            ...
            function h() {
                ...
                }), b.events.on("position.refresh", function() {
                    return b.helpers.isIOS() ? !c() : void 0
            ...
            function d() {
                for (var a = '<div class="fr-help-modal">', c = 0; c < b.opts.helpSets.length; c++) {
                    var d = b.opts.helpSets[c],
                        e = "<table>";
                    e += "<thead><tr><th>" + b.language.translate(d.title) + "</th></tr></thead>", e += "<tbody>";
                    for (var f = 0; f < d.commands.length; f++) {
                        var g = d.commands[f];
                        e += "<tr>", e += "<td>" + b.language.translate(g.desc) + "</td>", e += "<td>" + g.val.replace("OSkey", b.helpers.isMac() ? "&#8984;" : "Ctrl+") + "</td>", e += "</tr>"
                    }
                    e += "</tbody></table>", a += e
                }
                return a += "</div>"
            ...
            function d() {
                ...
                if (c || (c = N()), t(), !c.hasClass("fr-active"))
            ...
            function i() {
                for (var c = "IMG" == b.el.tagName ? [b.el] : b.el.querySelectorAll("img"), d = 0; d < c.length; d++) {
                    var e = a(c[d]);
                    !b.opts.htmlUntouched && b.opts.useClasses ? ((b.opts.imageDefaultAlign || b.opts.imageDefaultDisplay) && g(e), b.opts.imageTextNear || (e.parents(".fr-img-caption").length > 0 ? e.parents(".fr-img-caption:first").removeClass("fr-dii").addClass("fr-dib") : e.removeClass("fr-dii").addClass("fr-dib"))) : b.opts.htmlUntouched || b.opts.useClasses || (b.opts.imageDefaultAlign || b.opts.imageDefaultDisplay) && h(e), b.opts.iframe && e.on("load", b.size.syncIframe)
                }
            }
            ...
            function j(c) {
                ...
                if (Sa)
                    for (d = 0; d < Sa.length; d++) f.indexOf(Sa[d].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(Sa[d])]);
                if (Sa && c) {
                    var i = [];
            ...
            function o(c) {
                ...
                if (Ga && Ea) {
                    ...
                    if (!e) return !1;
                    var f = Ga.data("start-x"),
                        g = e - f,
                        h = Ga.data("start-width");
            ...
            function w() {
                var a = b.popups.get("image.insert"),
                    c = a.find(".fr-image-by-url-layer input");
                if (c.val().length > 0) {
                    s(), u(b.language.translate("Loading image"));
                    var d = c.val();
                    if (b.opts.imageUploadRemoteUrls && b.opts.imageCORSProxy && b.opts.imageUpload) {
                        var e = new XMLHttpRequest;
                        e.responseType = "blob", e.onload = function() {
                            200 == this.status ? I([new Blob([this.response], {
                                type: this.response.type || "image/png"
                            })], Ea) : q(Ja)
                        }, e.onerror = function() {
                            z(d, !0, [], Ea)
                        }, e.open("GET", b.opts.imageCORSProxy + "/" + d, !0), e.send()
                    } else z(d, !0, [], Ea);
                    c.val(""), c.blur()
                }
            }
            ...
            function z(a, c, d, e, f) {
                ...
                g.onload = function() {
                    ...
                    if (e) {
                        ...
                        c.on("load", y), c.attr("src", a), b.edit.on(), j(!1), b.undo.saveStep(), b.events.disableBlur(), b.$el.blur(), b.events.trigger(h ? "image.replaced" : "image.inserted", [c, f])
            ...
            function K(a) {
                return a.is("img") && a.parents(".fr-img-caption").length > 0 ? a.parents(".fr-img-caption") : void 0
            }
            ...
            function L(c) {
                ...
                if (d && d.files && d.files.length) {
                    var e = d.files[0];
                    if (e && e.type && -1 !== e.type.indexOf("image") && b.opts.imageAllowedTypes.indexOf(e.type.replace(/image\//g, "")) >= 0) {
            ...
            function M() {
                b.events.$on(b.$el, b._mousedown, "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function(c) {
                    return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable") ? !0 : (b.helpers.isMobile() || b.selection.clear(), Ia = !0, b.popups.areVisible() && b.events.disableBlur(), b.browser.msie && (b.events.disableBlur(), b.$el.attr("contenteditable", !1)), b.draggable || "touchstart" == c.type || c.preventDefault(), void c.stopPropagation())
                }), b.events.$on(b.$el, b._mouseup, "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function(c) {
                    return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable") ? !0 : void(Ia && (Ia = !1, c.stopPropagation(), b.browser.msie && (b.$el.attr("contenteditable", !0), b.events.enableBlur())))
                }), b.events.on("keyup", function(c) {
            ...
            function ba(a) {
                if (a && "IMG" == a.tagName) {
                    ...
                    for (var e = a.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), f = 0; f < e.length; f++) ba(e[f])
            }
            ...
            function ca() {
                if (M(), "IMG" == b.el.tagName && b.$el.addClass("fr-view"), b.events.$on(b.$el, b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', ja), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                        ...
                        return Ea && b.which == a.FE.KEYCODE.ENTER ? !1 : void 0
                        ...
                        if (Ea && b.popups.isVisible("image.edit") && !b.popups.get("image.edit").find(":focus").length) {
                            var d = Aa();
                            Ca() ? (d.before(a.FE.START_MARKER), d.after(a.FE.END_MARKER), b.selection.restore(), b.paste.saveCopiedText(d.get(0).outerHTML, d.text())) : (xa(), b.paste.saveCopiedText(Ea.get(0).outerHTML, Ea.attr("alt"))), "copy" == c.type ? setTimeout(function() {
                                x(Ea)
                        ...
                        var c = b.which;
                        return Ea && c == a.FE.KEYCODE.BACKSPACE ? (b.preventDefault(), !1) : void 0
                ...
                b.opts.iframe && b.events.on("image.loaded", b.size.syncIframe), b.$wp && (j(), b.events.on("contentChanged", j)), b.events.$on(a(b.o_win), "orientationchange.image", function() {
                    ...
                    return "IMG" == a.get(0).tagName ? (_(a), !1) : void 0
                })
            }
            ...
            function ea() {
                b.opts.imagePaste ? b.$el.find("img[data-fr-image-pasted]").each(function(c, d) {
                    if (b.opts.imagePasteProcess) {
                        ...
                        e && "auto" != e && (e += b.opts.imageResizeWithPercent ? "%" : "px"), a(d).css("width", e).removeClass("fr-dii fr-dib fr-fir fr-fil"), oa(a(d), b.opts.imageDefaultDisplay, b.opts.imageDefaultAlign)
                    }
                    if (0 === d.src.indexOf("data:")) da(d);
            ...
            function fa(a) {
                ...
                d && "auto" != d && (d += b.opts.imageResizeWithPercent ? "%" : "px"), b.undo.saveStep(), b.html.insert('<img data-fr-image-pasted="true" src="' + c + '"' + (d ? ' style="width: ' + d + ';"' : "") + ">");
                var e = b.$el.find('img[data-fr-image-pasted="true"]');
                e && oa(e, b.opts.imageDefaultDisplay, b.opts.imageDefaultAlign), b.events.trigger("paste.after")
            }
            ...
            function Ca() {
                return Ea ? Ea.parents(".fr-img-caption").length > 0 : !1
            }
            ...
            function c() {
                if (!z) {
                    ...
                    var c;
                    c = b.opts.imageManagerPreloader ? '<img class="fr-preloader" id="fr-preloader" alt="' + b.language.translate("Loading") + '.." src="' + b.opts.imageManagerPreloader + '" style="display: none;">' : '<span class="fr-preloader" id="fr-preloader" style="display: none;">' + b.language.translate("Loading") + "</span>", c += '<div class="fr-image-list" id="fr-image-list"></div>';
            ...
            function f() {
                D.empty();
                for (var a = 0; J > a; a++) D.append('<div class="fr-list-column"></div>')
            }
            ...
            function s(c, d) {
                c >= 10 && 20 > c ? C.hide() : c >= 20 && 30 > c && a(".fr-image-deleting").removeClass("fr-image-deleting"), b.events.trigger("imageManager.error", [{
                    code: c,
                    message: T[c]
                }, d])
            }
            ...
            function y() {
                return b.$wp || "IMG" == b.el.tagName ? void 0 : !1
            }
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        function c(c, d) {
            ...
            else if (null == d) h = c.parent(), j = h.offset().top + h.outerHeight(), l = c.offset().top + c.outerHeight(), l > j && (h = a(h).parent(), j = h.offset().top + h.outerHeight()), e = l + Math.min(Math.abs(j - l) / 2, b.opts.lineBreakerOffset), g = h.outerWidth(), f = h.offset().left;
            else {
                h = c.parent();
        ...
        function k(a) {
            return r.hasClass("fr-visible") && !b.core.sameInstance(r) ? !1 : b.popups.areVisible() || b.el.querySelector(".fr-selected-cell") ? (r.removeClass("fr-visible"), !0) : void(s !== !1 || b.edit.isDisabled() || (t && clearTimeout(t), t = setTimeout(j, 30, a)))
        }
        ...
        function q() {
            return b.$wp ? (p(), s = !1, b.events.$on(b.$win, "mousemove", k), b.events.$on(a(b.win), "scroll", l), b.events.on("popups.show.table.edit", l), b.events.on("commands.after", l), b.events.$on(a(b.win), "mousedown", m), void b.events.$on(a(b.win), "mouseup", n)) : !1
        }
        var r, s, t;
        return {
            _init: q
        ...
        function c() {
            ...
            if (!c && b.$wp) {
                ...
                try {
                    d && (d.contains && d.contains(b.el) || !b.el.contains(d) || b.el == d) && (d = null)
                } catch (e) {
                    d = null
                }
                if (d && "A" === d.tagName) return d;
                var f = b.selection.element(),
                    g = b.selection.endElement();
                "A" == f.tagName || b.node.isElement(f) || (f = a(f).parentsUntil(b.$el, "a:first").get(0)), "A" == g.tagName || b.node.isElement(g) || (g = a(g).parentsUntil(b.$el, "a:first").get(0));
                try {
                    g && (g.contains && g.contains(b.el) || !b.el.contains(g) || b.el == g) && (g = null)
                } catch (e) {
                    g = null
                }
                try {
        ...
        function n() {
            b.events.on("keyup", function(b) {
                ...
                return b.popups.isVisible("link.edit") ? (b.events.disableBlur(), b.events.focus(), !1) : void 0
            }, !0)
        }
        ...
        function r(f, g, h) {
            ...
            var m, n = c();
            if (n) {
                if (m = a(n), m.attr("href", f), g.length > 0 && m.text() != g && !i) {
                    for (var o = m.get(0); 1 === o.childNodes.length && o.childNodes[0].nodeType == Node.ELEMENT_NODE;) o = o.childNodes[0];
                    a(o).text(g)
                }
                i || m.prepend(a.FE.START_MARKER).append(a.FE.END_MARKER), m.attr(h), i || b.selection.restore()
            } else {
                i ? i.wrap('<a href="' + f + '"></a>') : (b.format.remove("a"), b.selection.isCollapsed() ? (g = 0 === g.length ? j : g, b.html.insert('<a href="' + f + '">' + a.FE.START_MARKER + g.replace(/&/g, "&amp;") + a.FE.END_MARKER + "</a>"), b.selection.restore()) : g.length > 0 && g != b.selection.text().replace(/\n/g, "") ? (b.selection.remove(), b.html.insert('<a href="' + f + '">' + a.FE.START_MARKER + g.replace(/&/g, "&amp;") + a.FE.END_MARKER + "</a>"), b.selection.restore()) : (q(), b.format.apply("a", {
                    href: f
                })));
                for (var p = d(), r = 0; r < p.length; r++) m = a(p[r]), m.attr(h), m.removeAttr("_moz_dirty");
            ...
            if (i) {
                ...
                s && s.find("input:focus").blur(), b.image.edit(i)
            } else e()
        }
        ...
        function g(g) {
            "N" == g && (g = b.html.defaultTag()), b.selection.save(), b.html.wrap(!0, !0, !b.opts.paragraphFormat.BLOCKQUOTE, !0, !0), b.selection.restore();
        ...
        function b() {
            ...
            Array.prototype.forEach.call(e, function(a) {
                ...
                b.rel = a.rel, b.href = a.href, b.media = "print", b.type = "text/css",
        ...
        function c(c) {
            var d, e, f;
            d = c.offset().top - b.$box.offset().top, e = 0 - k.outerWidth(), b.opts.enter != a.FE.ENTER_BR ? f = (k.outerHeight() - c.outerHeight()) / 2 : (a("<span>" + a.FE.INVISIBLE_SPACE + "</span>").insertAfter(c), f = (k.outerHeight() - c.next().outerHeight()) / 2, c.next().remove()), b.opts.iframe && (d += b.$iframe.offset().top - b.helpers.scrollTop()), k.hasClass("fr-on") && d >= 0 && l.css("top", d - f), d >= 0 && d - f <= b.$box.outerHeight() - c.outerHeight() ? (k.hasClass("fr-hidden") && (k.hasClass("fr-on") && g(), k.removeClass("fr-hidden")), k.css("top", d - f)) : k.hasClass("fr-visible") && (k.addClass("fr-hidden"), h()), k.css("left", e)
        }
        ...
        function e() {
            if (b.core.hasFocus()) {
                var c = b.selection.element();
                if (b.opts.enter == a.FE.ENTER_BR || b.node.isBlock(c) || (c = b.node.blockParent(c)), b.opts.enter == a.FE.ENTER_BR && !b.node.isBlock(c)) {
                    var e = b.node.deepestParent(c);
                    e && (c = e)
                }
                var g = function() {
                        return b.opts.enter != a.FE.ENTER_BR && b.node.isEmpty(c) && b.node.isElement(c.parentNode) && b.opts.quickInsertTags.indexOf(c.tagName.toLowerCase()) >= 0
                    },
                    i = function() {
                        return b.opts.enter == a.FE.ENTER_BR && ("BR" == c.tagName && (!c.previousSibling || "BR" == c.previousSibling.tagName || b.node.isBlock(c.previousSibling)) || b.node.isEmpty(c) && (!c.previousSibling || "BR" == c.previousSibling.tagName || b.node.isBlock(c.previousSibling)) && (!c.nextSibling || "BR" == c.nextSibling.tagName || b.node.isBlock(c.nextSibling)))
                    };
                c && (g() || i()) ? k && k.data("tag").is(a(c)) && k.hasClass("fr-on") ? h() : b.selection.isCollapsed() && d(a(c)) : f()
            }
        }
        ...
        function d(d) {
            ...
            var e = d,
                f = b.events.trigger("save.before", [d]);
            if (f === !1) return !1;
            if ("string" == typeof f && (d = f), b.opts.saveURL) {
                var g = {};
                for (var h in b.opts.saveParams)
                    if (b.opts.saveParams.hasOwnProperty(h)) {
        ...
        function h(a) {
            ...
            for (var f = 1; f <= b.opts.tableInsertMaxSize; f++)
                for (var g = 0; g <= b.opts.tableInsertMaxSize; g++) {
                    ...
                    c >= f && d >= g ? h.addClass("hover") : c + 1 >= f || 2 >= f && !b.helpers.isMobile() ? h.css("display", "inline-block") : f > 2 && !b.helpers.isMobile() && h.css("display", "none")
                }
        ...
        function y(a, b, c) {
            var d, e, f, g, h, i = 0,
                j = J(c);
            if (b = Math.min(b, j[0].length - 1), b > a)
                for (e = a; b >= e; e++)
        ...
        function z(a, b, c) {
            var d, e, f, g, h, i = 0,
                j = J(c);
            if (b = Math.min(b, j.length - 1), b > a)
                for (d = a; b >= d; d++)
        ...
        function Q(b, c, d, e, f) {
            var g, h, i, j, k = b,
                ...
                m = d,
                n = e;
            for (g = k; l >= g; g++)((parseInt(a(f[g][m]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][m]).attr("colspan"), 10) || 1) > 1) && (i = K(f[g][m], f), j = L(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n)), ((parseInt(a(f[g][n]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][n]).attr("colspan"), 10) || 1) > 1) && (i = K(f[g][n], f), j = L(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n));
        ...
        function V(c) {
            var d = T(c);
            if ("false" == a(d).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable")) return !0;
        ...
        function ba() {
            b.shared.$table_resizer || (b.shared.$table_resizer = a('<div class="fr-table-resizer"><div></div></div>')), ya = b.shared.$table_resizer, b.events.$on(ya, "mousedown", function(a) {
                return b.core.sameInstance(ya) ? (ta().length > 0 && U(), 1 == a.which ? (b.selection.save(), Ea = !0, ya.addClass("fr-moving"), O(), b.edit.off(), ya.find("div").css("opacity", 1), !1) : void 0) : !0
            }), b.events.$on(ya, "mousemove", function(a) {
                return b.core.sameInstance(ya) ? void(Ea && (b.opts.iframe && (a.pageX -= b.$iframe.offset().left), na(a))) : !0
            ...
            if (d && "TD" != d.tagName && "TH" != d.tagName && (e.closest("td").length > 0 ? d = e.closest("td") : e.closest("th").length > 0 && (d = e.closest("th"))), !d || "TD" != d.tagName && "TH" != d.tagName) ya && e.get(0) != ya.get(0) && e.parent().get(0) != ya.get(0) && b.core.sameInstance(ya) && ca();
                ...
                if (Math.abs(c.pageX - h) <= b.opts.tableResizerOffset || Math.abs(i - c.pageX) <= b.opts.tableResizerOffset) {
                    ...
                    var t = l - b.win.pageXOffset - b.opts.tableResizerOffset - b.$wp.offset().left,
                        u = r - b.$wp.offset().top + b.$wp.scrollTop();
                    b.opts.iframe && (t += b.$iframe.offset().left, u += b.$iframe.offset().top, m += b.$iframe.offset().left, n += b.$iframe.offset().left), ya.data("max-left", m), ya.data("max-right", n), ya.data("origin", l - b.win.pageXOffset), ya.css("top", u), ya.css("left", t), ya.css("height", s), ya.find("div").css("height", s), ya.css("padding-left", b.opts.tableResizerOffset), ya.css("padding-right", b.opts.tableResizerOffset), ya.show()
        ...
        function fa(c, d) {
            ...
            f.find("th, td").each(function() {
                var c = a(this);
                return c.offset().left <= g && g < c.offset().left + c.outerWidth() / 2 ? (j = parseInt(za.find("a").css("width"), 10), za.css("top", i + c.offset().top - b.$box.offset().top - b.win.pageYOffset - j - 5), za.css("left", h + c.offset().left - b.$box.offset().left - b.win.pageXOffset - j / 2),
        ...
        function ma(a, b, c) {
            var d, e = 0;
            for (d = a; b >= d; d++) e += la(d, c);
            return e
        }

        function na(a) {
            if (ta().length > 1 && Ba && O(), Ba === !1 && Aa === !1 && Ea === !1) Da && clearTimeout(Da), (!b.edit.isDisabled() || b.popups.isVisible("table.edit")) && (Da = setTimeout(ia, 30, a));
            else if (Ea) {
                var c = a.pageX - b.win.pageXOffset;
                b.opts.iframe && (c += b.$iframe.offset().left);
                var d = ya.data("max-left"),
                    e = ya.data("max-right");
                c >= d && e >= c ? ya.css("left", c - b.opts.tableResizerOffset - b.$wp.offset().left) : d > c && parseFloat(ya.css("left"), 10) > d - b.opts.tableResizerOffset ? ya.css("left", d - b.opts.tableResizerOffset - b.$wp.offset().left) : c > e && parseFloat(ya.css("left"), 10) < e - b.opts.tableResizerOffset && ya.css("left", e - b.opts.tableResizerOffset - b.$wp.offset().left)
            } else Ba && da()
        }
        ...
        function xa() {
            ...
            if (!b.helpers.isMobile()) {
                Ba = !1, Aa = !1, Ea = !1, b.events.$on(b.$el, "mousedown", V), b.popups.onShow("image.edit", function() {
                    ...
                    return ta().length > 0 ? (b.events.disableBlur(), b.events.focus(), !1) : void 0
        ...
        function e(a) {
            return b.opts.linkAlwaysNoFollow && (j = "nofollow"), b.opts.linkAlwaysBlank && (b.opts.linkNoOpener && (j ? j += " noopener" : j = "noopener"), b.opts.linkNoReferrer && (j ? j += " noreferrer" : j = "noreferrer")), a.replace(d(), c)
        }

        function f(a) {
            return a ? "A" === a.tagName ? !0 : a.parentNode && a.parentNode != b.el ? f(a.parentNode) : !1 : !1
        }
        ...
        function i() {
            b.events.on("keypress", function(a) {
                !b.selection.isCollapsed() || "." != a.key && ")" != a.key && "(" != a.key || h()
            }, !0), b.events.on("keydown", function(c) {
                var d = c.which;
                !b.selection.isCollapsed() || d != a.FE.KEYCODE.ENTER && d != a.FE.KEYCODE.SPACE || h()
            }, !0), b.events.on("paste.beforeCleanup", function(a) {
                if (b.helpers.isURL(a)) {
                    var c = null;
                    return b.opts.linkAlwaysBlank && (b.opts.linkNoOpener && (c ? c += " noopener" : c = "noopener"), b.opts.linkNoReferrer && (c ? c += " noreferrer" : c = "noreferrer")), "<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") + (c ? ' rel="' + c + '"' : "") + ' href="' + a + '" >' + a + "</a>"
                }
            })
        }
        var j = null;
        ...
        test_regex: /https?:\/\/view\.vzaar\.com\/([0-9]+).+?/,
        url_regex: /(?:https?:\/\/)?(?:www\.)?(?:m\.)?(view\.vzaar\.com\/([0-9]+).+)?/i,
        url_text: "$2",
        html: '<iframe id="vzvd-123456" name="vzvd-123456" title="vzaar video player" class="vzaar-video-player" type="text/html" width="640" height="360" frameborder="0" allowfullscreen allowTransparency="true" mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/{url}/player"></iframe>',
        provider: "vimeo"
    }, {
        test_regex: /(clips\.)?twitch\.tv\/(?:(?:videos\/(\d+))|(\w+))?/,
        url_regex: /^.*(?:(?:twitch.tv))\/videos\/?([^#\&\?]*).*/,
        url_text: "https://player.twitch.tv/?autoplay=false&video=v$1",
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vimeo"
    },{
        test_regex: /^(?:https?:\/\/www\.facebook\.com\/(?:video\.php\?v=+|.*?\/videos\/)(\d+))/,
        url_regex: /^(https?:\/\/www\.facebook\.com\/(?:video\.php\?v=\d+|.*?\/videos\/\d+))/,
        url_text: "https://www.facebook.com/plugins/video.php?href=$1",
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vimeo"
    }, {
        ...
        function D(a) {
            return b.core.sameInstance(qa) ? void(pa && ra && (a && a.stopPropagation(), pa = null, oa.hide(), I(), e(), b.undo.saveStep())) : !0
        }
        ...
        function H() {
            var c, d = Array.prototype.slice.call(b.el.querySelectorAll("video, .fr-video > *")),
                e = [];
        ...
        function J(c) {
            ...
            b.toolbar.disable(), b.helpers.isMobile() && (b.events.disableBlur(), b.$el.blur(), b.events.enableBlur()), b.$el.find(".fr-video.fr-active").removeClass("fr-active"), ra = a(this), ra.addClass("fr-active"), b.opts.iframe && b.size.syncIframe(), ka(), I(), e(), b.selection.clear(), b.button.bulkRefresh(), b.events.trigger("image.hideResizer")
        }
        ...
        function Z(a) {
            return ra ? void a.find("> *:first").replaceWith(b.icon.create("video-align-" + X())) : !1
        }
        ...
        function ja() {
            R(), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "span.fr-video", function() {
                ...
                a.stopPropagation()
            }), b.events.$on(b.$el, "click touchend", "span.fr-video", function(b) {
                return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable") ? !0 : void J.call(this, b)
            }), b.events.on("keydown", function(c) {
                var d = c.which;
                ...
                return ra ? (b.events.disableBlur(), b.events.focus(), !1) : void 0
            }, !0), b.events.on("toolbar.focusEditor", function() {
                return ra ? !1 : void 0
            }, !0), b.events.on("keydown", function() {
                b.$el.find("span.fr-video:empty").remove()
            }), b.$wp && (H(), b.events.on("contentChanged", H)), f(!0), W(!0)
        }
        ...
        function l(a, b) {
            var c = a.cloneNode(!0);
            if (-1 != ["H1", "H2", "H3", "H4", "H5", "H6"].indexOf(a.tagName)) {
        ...
        function u(a, b, c) {
            for (var d = a.split(c), e = 1; e < d.length; e++) {
                ...
                if (f = f.split("shplid"), f.length > 1) {
                    ...
                    var j = null;
                    if (-1 != i[0].indexOf("pngblip") ? j = "image/png" : -1 != i[0].indexOf("jpegblip") && (j = "image/jpeg"), !j) continue;
                    var k = i[1].split("}");
        ...
        function x(a, b) {
            ...
            if (-1 != e.indexOf(c)) return h(a), !1;
            var f = -1,
                g = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
            for (f = 0; f < g.length; f++)
                if (-1 != c.indexOf(g[f])) return a.innerHTML ? (a.outerHTML = a.innerHTML, h(a), !1) : (h(a), !1);
            if ("TD" != c) {
            ...
            if (-1 != t.indexOf(c)) {
                ...
                if (u && (b && b[c.toLowerCase() + "." + u] && r(a, b[c.toLowerCase() + "." + u]), -1 != u.toLowerCase().indexOf("mso"))) {
                    var v = q(u);
            ...
            if ("TR" == c && o(a, b), "A" == c && !a.attributes.getNamedItem("href") && a.innerHTML && (a.outerHTML = a.innerHTML), "TD" != c && "TH" != c || a.innerHTML || (a.innerHTML = "<br>"), "TABLE" == c && (a.style.width = "100%"), a.getAttribute("lang") && a.removeAttribute("lang"), a.getAttribute("style") && -1 != a.getAttribute("style").toLowerCase().indexOf("mso")) {
        ...
        function A(c, d) {
            ...
            i(k, function(b) {
                if (b.nodeType == Node.TEXT_NODE && /\n|\u00a0|\r/.test(b.data)) {
                    if (!/\S| /.test(b.data)) return b.data == a.FE.UNICODE_NBSP ? (b.data = "\u200b", !0) : 1 == b.data.length && 10 == b.data.charCodeAt(0) ? (b.data = " ", !0) : (h(b), !1);
            ...
            for (var n = k.querySelectorAll("ul > ul, ul > ol, ol > ul, ol > ol"), o = n.length - 1; o >= 0; o--) n[o].previousElementSibling && "LI" === n[o].previousElementSibling.tagName && n[o].previousElementSibling.appendChild(n[o]);
            i(k, function(a) {
                ...
                return a.nodeType == Node.COMMENT_NODE ? (h(a), !1) : !0
            }), i(k, function(a) {
                if (a.nodeType == Node.ELEMENT_NODE) {
                    var b = a.tagName;
            ...
            var p = k.outerHTML,
                q = b.opts.htmlAllowedStyleProps;
            return b.opts.htmlAllowedStyleProps = b.opts.wordAllowedStyleProps, p = b.clean.html(p, b.opts.wordDeniedTags, b.opts.wordDeniedAttrs, !1), b.opts.htmlAllowedStyleProps = q, p
        }
